...
export default function ProjectCard({ item }) {
  return (
    <div className="group relative block  aspect-video max-w-[90vw]	">
      ...
      >
        <div className="absolute h-full w-full p-4 text-center opacity-0 transition-opacity hover:opacity-90  group-hover:relative group-hover:bg-stone-900 sm:p-6 lg:p-8">
